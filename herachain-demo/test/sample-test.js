...
describe("EMR Contract Tests", function () {
  ...
  it("Should create an EMR Contract", async function () {
    ...
    const emr_deploy = await emr.deploy("test", "test", 1650505906, "QmNS4xrK3FT9c2FxocxqGpJxWHWXxf5dzv72sritQbkP3P", "QmNS4xrK3FT9c2FxocxqGpJxWHWXxf5dzv72sritQbkP3P", (await rewarder_address).address);
  ...
  it("Should transfer heracoin to the EMR creator", async function () {
    ...
    const emr = await ethers.getContractFactory("EMRContract");
    const emr_deploy = await emr.connect(patient).deploy("test", "test", 1650505906, "QmNS4xrK3FT9c2FxocxqGpJxWHWXxf5dzv72sritQbkP3P", "QmNS4xrK3FT9c2FxocxqGpJxWHWXxf5dzv72sritQbkP3P", (await rewarder_address).address);
  ...
  it("Should not allow one patient to access another patient's EMRs", async function () {
    ...
    const emr = await ethers.getContractFactory("EMRContract");
    const emr1 = await emr.connect(patient1).deploy("test1", "test1", 1650505906, "QmNS4xrK3FT9c2FxocxqGpJxWHWXxf5dzv72sritQbkP3P", "QmNS4xrK3FT9c2FxocxqGpJxWHWXxf5dzv72sritQbkP3P", (await rewarder_address).address);
    const emr2 = await emr.connect(patient2).deploy("test2", "test2", 1650505906, "QmNS4xrK3FT9c2FxocxqGpJxWHWXxf5dzv72sritQbkP3P", "QmNS4xrK3FT9c2FxocxqGpJxWHWXxf5dzv72sritQbkP3P", (await rewarder_address).address);
